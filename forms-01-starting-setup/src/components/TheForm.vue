<template>
  <form @submit.prevent="submitForm">
    <div class="form-control">
      ...
      <input id="user-name" name="user-name" type="text" v-model="userName" @blur="validateInput" :class="{invalid: userNameValidity === 'invalid'}" />
    </div>
    <div class="form-control">
...
export default {
  ...
  methods: {
    ...
    validateInput() {
      if (this.userName === '') {
        this.userNameVilidity = 'invalid';
      } else {
        this.userNameVilidity = 'valid';
      }
    }
  },
};
